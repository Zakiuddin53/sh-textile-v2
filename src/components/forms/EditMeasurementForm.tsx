...
import { Button, Flex, SimpleGrid, Title, Stack, TextInput, Tabs, Paper, Box, Textarea } from "@mantine/core";
    ...
    <form onSubmit={form.onSubmit(handleSubmit)}>
      <Stack gap="xl">
        ...
        <Paper shadow="xs" p="md" withBorder>
          ...
          <Textarea placeholder="Add any additional notes or special instructions" minRows={3} {...form.getInputProps("note.text")} styles={{ input: { color: "black" } }} />
        </Paper>
        ...
        <Paper shadow="xs" p="md" withBorder>
          ...
          <Tabs defaultValue="sherwani">
            <Tabs.List>
              ...
              <Tabs.Tab c="blue" value="shirt" leftSection={<IconJacket size={16} />}>
                Shirt
              </Tabs.Tab>
              <Tabs.Tab c="blue" value="sadri" leftSection={<IconJacket size={16} />}>
                Sadri
              </Tabs.Tab>
            </Tabs.List>
            ...
            <Box mt="md">
              ...
              <Tabs.Panel value="sadri">
                <SimpleGrid cols={3}>
                  <MeasurementInput c="black" label="Length" placeholder="Enter length" {...form.getInputProps("sadri.length")} />
                  <MeasurementInput c="black" label="Chest" placeholder="Enter chest" {...form.getInputProps("sadri.chest")} />
                  <MeasurementInput c="black" label="Below Chest" placeholder="Enter below chest" {...form.getInputProps("sadri.belowChest")} />
                  <MeasurementInput c="black" label="Stomach" placeholder="Enter stomach" {...form.getInputProps("sadri.stomach")} />
                  <MeasurementInput c="black" label="Hip" placeholder="Enter hip" {...form.getInputProps("sadri.hip")} />
                  <MeasurementInput c="black" label="Neck" placeholder="Enter neck" {...form.getInputProps("sadri.neck")} />
                  <MeasurementInput c="black" label="Shoulder" placeholder="Enter shoulder" {...form.getInputProps("sadri.shoulder")} />
                </SimpleGrid>
              </Tabs.Panel>
            </Box>
          </Tabs>
        ...
        <Paper shadow="xs" p="md" withBorder>
          ...
          <Tabs defaultValue="trouser">
            <Tabs.List>
              <Tabs.Tab c="blue" value="trouser" leftSection={<IconHanger size={16} />}>
                Trouser
              </Tabs.Tab>
              <Tabs.Tab c="blue" value="pant" leftSection={<IconHanger size={16} />}>
                Pant
              </Tabs.Tab>
              ...
              <Tabs.Tab c="blue" value="choodidar" leftSection={<IconHanger size={16} />}>
                Chooridar Paejama
              </Tabs.Tab>
            </Tabs.List>
            ...
            <Box mt="md">
              ...
              <Tabs.Panel value="trouser">
                <SimpleGrid cols={3}>
                  ...
                  <MeasurementInput c="black" label="Knee" placeholder="Enter thigh" {...form.getInputProps("trouser.thigh")} />
                </SimpleGrid>
              </Tabs.Panel>
              ...
              <Tabs.Panel value="pant">
                <SimpleGrid cols={3}>
                  ...
                  <MeasurementInput c="black" label="Calf" placeholder="Enter calf" {...form.getInputProps("pant.calf")} />
              ...
              <Tabs.Panel value="paejama">
                <SimpleGrid cols={3}>
                  <MeasurementInput c="black" label="Length" placeholder="Enter length" {...form.getInputProps("paejama.length")} />
                  <MeasurementInput c="black" label="Hip" placeholder="Enter hip" {...form.getInputProps("paejama.hip")} />
                  <MeasurementInput c="black" label="Waist" placeholder="Enter waist" {...form.getInputProps("paejama.waist")} />
                  <MeasurementInput c="black" label="Mohri" placeholder="Enter mohri" {...form.getInputProps("paejama.mohri")} />
                </SimpleGrid>
              </Tabs.Panel>
              ...
              <Tabs.Panel value="shalwar">
                <SimpleGrid cols={3}>
                  <MeasurementInput c="black" label="Length" placeholder="Enter length" {...form.getInputProps("shalwar.length")} />
                  <MeasurementInput c="black" label="Hip" placeholder="Enter hip" {...form.getInputProps("shalwar.hip")} />
                  <MeasurementInput c="black" label="Waist" placeholder="Enter waist" {...form.getInputProps("shalwar.waist")} />
                  <MeasurementInput c="black" label="Mohri" placeholder="Enter mohri" {...form.getInputProps("shalwar.mohri")} />
                </SimpleGrid>
              </Tabs.Panel>
              ...
              <Tabs.Panel value="choodidar">
                <SimpleGrid cols={3}>
                  ...
                  <MeasurementInput c="black" label="Mohri" placeholder="Enter mohri" {...form.getInputProps("choodidarPaejama.mohri")} />
                </SimpleGrid>
              </Tabs.Panel>
            </Box>
          </Tabs>
