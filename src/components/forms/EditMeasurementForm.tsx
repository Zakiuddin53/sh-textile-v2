            ...
            <Box mt="md">
              ...
              <Tabs.Panel value="kurta">
                <SimpleGrid cols={3}>
                  ...
                  <MeasurementInput c="black" label="Blow Chest" placeholder="Enter blow chest" {...form.getInputProps("kurta.blowChest")} />
                  ...
                  <MeasurementInput c="black" label="Cap" placeholder="Enter cap" {...form.getInputProps("kurta.cap")} />
                  <MeasurementInput c="black" label="Full Height" placeholder="Enter full height" {...form.getInputProps("kurta.fullHeight")} />
                </SimpleGrid>
              </Tabs.Panel>
              ...
              <Tabs.Panel value="coat">
                <SimpleGrid cols={3}>
                  ...
                  <MeasurementInput c="black" label="Cap" placeholder="Enter cap" {...form.getInputProps("coat.cap")} />
